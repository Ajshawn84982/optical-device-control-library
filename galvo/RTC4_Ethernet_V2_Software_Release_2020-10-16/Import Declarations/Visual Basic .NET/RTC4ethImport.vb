...
Module RTC4eth
    ...
    Declare Function rs232_read_data Lib "RTC4ethDLL.DLL" (ByVal data As IntPtr) As UInteger
    Declare Function n_rs232_read_data Lib "RTC4ethDLL.DLL" (ByVal n As UShort, ByVal data As IntPtr) As UInteger
